 ...
 */
final class Version20201208205440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transact (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, parish_id INT DEFAULT NULL, transaction_category_id INT DEFAULT NULL, value INT DEFAULT NULL, copies INT DEFAULT 1 NOT NULL, transcription LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_FA42B7F616A2B381 (book_id), INDEX IDX_FA42B7F68707B11F (parish_id), INDEX IDX_FA42B7F6AECF88CF (transaction_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
