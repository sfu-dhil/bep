 ...
 */
final class Version20201208200812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE town (id INT AUTO_INCREMENT NOT NULL, county_id INT DEFAULT NULL, name VARCHAR(120) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, label VARCHAR(120) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, in_london TINYINT(1) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, FULLTEXT INDEX IDX_4CE6C7A46DE44026 (description), INDEX IDX_4CE6C7A485E73F45 (county_id), FULLTEXT INDEX IDX_4CE6C7A4EA750E8 (label), FULLTEXT INDEX IDX_4CE6C7A4EA750E86DE44026 (label, description), UNIQUE INDEX UNIQ_4CE6C7A45E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE transact (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, parish_id INT DEFAULT NULL, transaction_category_id INT DEFAULT NULL, value INT DEFAULT NULL, description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, created DATETIME NOT NULL, updated DATETIME NOT NULL, copies INT DEFAULT 1 NOT NULL, transcription LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_FA42B7F616A2B381 (book_id), INDEX IDX_FA42B7F68707B11F (parish_id), INDEX IDX_FA42B7F6AECF88CF (transaction_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
