...
class MonarchTest extends ControllerTestCase {
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertResponseRedirects('/monarch/1', Response::HTTP_FOUND);
    ...
    public function testAdminNew() : void {
        ...
        $this->client->submit($form);
        $this->assertResponseRedirects('/monarch/6', Response::HTTP_FOUND);
        $responseCrawler = $this->client->followRedirect();
        $this->assertResponseIsSuccessful();
    }
    ...
    public function testAdminNewPopup() : void {
        ...
        $this->client->submit($form);
        $this->assertResponseRedirects('/monarch/7', Response::HTTP_FOUND);
        $responseCrawler = $this->client->followRedirect();
        $this->assertResponseIsSuccessful();
    }
}
