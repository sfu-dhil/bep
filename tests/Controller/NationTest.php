...
class NationTest extends ControllerBaseCase
{
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/nation/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAnonSearch() : void {
        $repo = $this->createMock(NationRepository::class);
        $repo->method('searchQuery')->willReturn([$this->getReference('nation.1')]);
        $this->client->disableReboot();
        $this->client->getContainer()->set('test.' . NationRepository::class, $repo);
    ...
    public function testAdminEdit() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/nation/1/edit');
        $this->assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());

        $form = $formCrawler->selectButton('Save')->form([
            'nation[label]' => 'Updated Label',
            'nation[description]' => 'Updated Description',
        ]);

        $this->client->submit($form);
        $this->assertTrue($this->client->getResponse()->isRedirect('/nation/1'));
    ...
    public function testAdminNew() : void {
        ...
        $form = $formCrawler->selectButton('Save')->form([
            'nation[label]' => 'New Label',
            'nation[description]' => 'New Description',
        ]);
    ...
    public function testAdminNewPopup() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/nation/new_popup');
        $this->assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() : void {
        $repo = self::$container->get(NationRepository::class);
