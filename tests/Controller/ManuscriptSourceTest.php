...
class ManuscriptSourceTest extends ControllerTestCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/manuscript_source/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAdminEdit() : void {
        $this->login(UserFixtures::ADMIN);
        $formCrawler = $this->client->request('GET', '/manuscript_source/1/edit');
        $this->assertResponseIsSuccessful();
