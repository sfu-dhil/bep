...
class ArchiveTest extends ControllerTestCase {
    ...
    public function testAdminEdit() : void {
        ...
        $form = $formCrawler->selectButton('Save')->form([
            'archive[label]' => 'Updated Label',
            'archive[description]' => '<p>Updated Text</p>',
        ]);

        $this->client->submit($form);
        $this->assertResponseRedirects('/archive/1', Response::HTTP_FOUND);
    ...
    public function testAdminNew() : void {
        ...
        $this->client->submit($form);
        $this->assertResponseRedirects('/archive/6', Response::HTTP_FOUND);
        $responseCrawler = $this->client->followRedirect();
        $this->assertResponseIsSuccessful();
    }
    ...
    public function testAdminNewPopup() : void {
        ...
        $this->client->submit($form);
        $this->assertResponseRedirects('/archive/7', Response::HTTP_FOUND);
        $responseCrawler = $this->client->followRedirect();
        $this->assertResponseIsSuccessful();
    }
}
