...
class FormatTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/format/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAnonSearch() : void {
        $repo = $this->createMock(FormatRepository::class);
        $repo->method('searchQuery')->willReturn([$this->getReference('format.1')]);
        $this->client->disableReboot();
        $this->client->getContainer()->set('test.' . FormatRepository::class, $repo);

        $crawler = $this->client->request('GET', '/format/search');
        $this->assertSame(self::ANON_RESPONSE_CODE, $this->client->getResponse()->getStatusCode());
        if (self::ANON_RESPONSE_CODE === Response::HTTP_FOUND) {
            // If authentication is required stop here.
            return;
    ...
    public function testAnonNewPopup() : void {
        $crawler = $this->client->request('GET', '/format/new_popup');
        $this->assertSame(Response::HTTP_FOUND, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAdminNew() : void {
        ...
        $form = $formCrawler->selectButton('Save')->form([
            'format[label]' => 'New Label',
            'format[description]' => 'New Description',
        ]);
    ...
    public function testAdminNewPopup() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/format/new_popup');
        $this->assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() : void {
        $repo = self::$container->get(FormatRepository::class);
